  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
		...
		<a href="add-edit-category" style="max-width: 150px; float: right; display: inline-block;" class="btn btn-block btn-success">Add Category</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
		  ...
		  @foreach($categories as $category)
		    ...
		    <td><a href="add-edit-category/{{ $category->id }}">Edit</a></td>	
		  </tr>
		  @endforeach
                  </tbody>
                </table>
